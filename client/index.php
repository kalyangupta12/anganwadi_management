...
<html lang="en">
  ...
  <body class="bg-white text-gray-900 min-h-screen">
        ...
        <div class="container mx-auto">
          ...
          >
            <div class="flex">
              <a
                href="/"
                class="px-4 py-3 hover:bg-govt-dark-blue transition-colors"
                >Home</a
              >
              <a
                href="#features"
    ...
    <section class="relative pt-28 pb-16 overflow-hidden">
      <!-- Background elements -->
      <div
        class="absolute inset-0 bg-gradient-to-r from-govt-light-blue to-govt-white clip-shape z-0"
      ></div>
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <ul class="space-y-2 text-sm">
                <li class="flex items-start">
                  ...
                  <span
                    >Registration for new academic session 2024-25 starts from
                    June 15, 2024</span
                  >
                </li>
                <li class="flex items-start">
                  ...
                  <span
                    >Teacher training workshop scheduled for July 10-15,
                    2024</span
                  >
                </li>
              </ul>
          ...
          <div class="relative animate-fade-in delay-200">
            <div
              class="absolute inset-0 bg-gradient-to-r from-govt-blue/20 to-govt-light-blue/50 rounded-lg transform rotate-2 scale-105"
            ></div>
    ...
    <section id="features" class="py-16 relative bg-govt-light-gray">
      <div class="container mx-auto px-4">
        ...
        <div class="offline-indicator mb-8">
          ...
          <span
            >Our application works offline! Perfect for areas with limited
    ...
    <footer class="pt-16 pb-8">
      <div class="container mx-auto px-4">
        ...
        >
          ...
          <div
            class="tricolor-border my-4 w-24 rounded-full h-1 bg-gradient-to-r from-orange-500 via-white to-green-500"
          ></div>

          <div class="text-xs text-govt-text-gray">
            <p class="mb-2">© 2024 Pratham Path. All rights reserved.</p>
            <div class="flex justify-center space-x-4">
              <a href="#" class="hover:text-govt-blue transition-colors"
                >Privacy Policy</a
              >
              <span>|</span>
              <a href="#" class="hover:text-govt-blue transition-colors"
